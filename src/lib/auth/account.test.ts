...
describe("getCurrentAccount", () => {
  ...
  it("maps a profiles query error to 'Não foi possível carregar o contexto da conta'", async () => {
  ...
  it("maps an accounts query error to 'Não foi possível carregar o contexto da conta'", async () => {
